...
The real shock is usually the down payment. A standard 20% on a $793,000 home is $158,600. Many buyers in California do put 20% just to avoid PMI, because the insurance premium on a $634,000 loan adds another $400–500/month. If you're putting less than 20% down, make sure you're running those numbers before you fall in love with a property. Use our free mortgage calculator to toggle PMI on and see exactly what your true monthly cost looks like.`,
    faqs: [
...
Phoenix metro has seen significant price appreciation, but secondary markets like Tucson and the Prescott area still offer sub-$300,000 options. In Tucson, the same 0.62% rate on a $285,000 home runs $147/month in property tax — and the total PITI drops to roughly $1,800/month. Worth running the numbers in multiple markets if you have flexibility.`,
    faqs: [
      ...
      { q: 'Is Phoenix a good place to buy a home right now?', a: 'Phoenix home prices appreciated sharply from 2020–2022, then corrected in 2023, and have since stabilized. The market is demand-driven by in-migration from California and other high-cost states. The key financial question is always rent vs. buy math — use our free mortgage calculator to see your full monthly cost at different price points, then compare that against local rents to decide.' },
    ],
  },
